...
save_name="model_tb_emb4.pt"
runtime="--use-gpu --save-model=$save_name"

args="$model_arch $data $optimizer $batching $runtime"
echo $args

echo "Training DLRM on Terabyte Dataset with Embedding Dimension 4"

$dlrm_pt_bin $args 2>&1

echo "Done (with Embedding Dimension 4)!"
...
echo "Training DLRM on Terabyte Dataset with Embedding Dimension 8"

$dlrm_pt_bin $args 2>&1

echo "Done (with Embedding Dimension 8)!"